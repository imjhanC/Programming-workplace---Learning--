...
public class Decryptor implements ActionListener {
   JFrame frame = new JFrame("Decrypter");
   JLabel label1 = new JLabel("Insert secret text here");
   JLabel label2 = new JLabel("Decrypted password");
   ...
   public Decryptor() {
      ...
      this.txt1.addFocusListener(new FocusListener() {
         public void focusGained(FocusEvent e) {
            if (Decryptor.this.txt1.getText().equals("Input password here...")) {
               Decryptor.this.txt1.setText("");
            }

         }

         public void focusLost(FocusEvent e) {
            if (Decryptor.this.txt1.getText().isEmpty()) {
               Decryptor.this.txt1.setText("Input password here...");
            }
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      if (e.getSource() == this.bttnConvert) {
         ...
         if (encryptedPassword.equals("Input password here...")) {
            ...
            String encryptedpassword = decrypt(encryptedPassword);
